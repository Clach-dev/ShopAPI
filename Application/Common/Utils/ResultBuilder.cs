...
{
    public static Result<T> SuccessResult<T>(T data) => new (true, HttpStatusCode.OK, data, default);
    
    public static Result<T> CreatedResult<T>(T data) => new (true, HttpStatusCode.Created, data, default);
    
    public static Result<T> NoContentResult<T>() => new (true, HttpStatusCode.NoContent, default, default);
